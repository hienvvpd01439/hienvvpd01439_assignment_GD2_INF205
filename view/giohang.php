...
<tr>
    <td colspan=6 class=tieude align=center>GIỎ HÀNG CỦA QU�? KH�?CH</td>
  </tr>
...
if($count=="")
{
	echo "<tr><td height=30 colspan=6 align=center style=\"padding-right:5px; padding-bottom:5px; color:#F00\">Không có sản phẩm nào trong gi�? hàng của Quý khách!</td></tr>";
}
else{
  echo "<tr>
  	<td height=30 colspan=6 align=right style=\"padding-right:5px; padding-bottom:5px; color:#F00\">Tổng số ti�?n phải thanh toán: $tongtien2 VND</td></tr>";
  echo "<tr>
	...
	<input type=\"button\" name=\"dathang\" value=\"�?ặt Hàng\" class=\"button2\" onmouseover=\"style.background='url(images/button-110-2-o.png)'\" onmouseout=\"style.background='url(images/button-110-o.png)'\" onclick=\"document.getElementById('thanhtoan').style.display='block'\"/>
	</form>
    </td>
  </tr>";  
}
	...
	<form id='k$id'>
	  ...
	  <tr>
		<td height=\"30\"><div style=\"padding-left:70px\">H�? và tên: </div></td>
		<td width=\"350\">		
		<input type=hidden name='act' /><input type=hidden name=id value='$id' />
			<input type=hidden name=b value='gh'>
	  ...
	  <tr>
		<td height=\"30\"><div style=\"padding-left:70px\">�?ịa chỉ:</div></td>
